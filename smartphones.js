/**
 * Boost Electronics – Smartphones Page
 * Matches headphones/laptops structure.
 */
...
const smartphones = [
  {
    ...
    brand: "apple",
    tags: ["Apple", "iPhone", "5G", "128GB", "A17 Pro"],
    price: 145000,
    oldPrice: 165000,
    stock: "In stock",
    images: [
    ...
    specs: [
      ...
      { feat: "RAM", spec: "8GB" },
      { feat: "Storage", spec: "128GB" },
      { feat: "Camera", spec: "48MP + 12MP + 12MP" },
      { feat: "Battery", spec: "Up to 23 hours video" }
    ],
    delivery: "1-2 days • 1 year warranty",
    description: "The most powerful iPhone ever with a titanium design.",
    rating: 4.9,
    reviews: 312
  },
  {
    ...
    category: "Smartphones",
    brand: "samsung",
    tags: ["Samsung", "Galaxy", "5G", "256GB", "S Pen"],
    price: 155000,
    oldPrice: 175000,
    stock: "In stock",
    ...
    specs: [
      { feat: "Display", spec: "6.8-inch Dynamic AMOLED 2X 120Hz" },
      { feat: "Processor", spec: "Snapdragon 8 Gen 3" },
      { feat: "RAM", spec: "12GB" },
      { feat: "Storage", spec: "256GB" },
      { feat: "Camera", spec: "200MP + 50MP + 12MP + 10MP" },
      { feat: "Battery", spec: "5000mAh" }
    ],
    delivery: "1-2 days",
    description: "The ultimate Android flagship with built-in S Pen.",
    rating: 4.8,
    reviews: 256
  },
  {
    ...
    category: "Smartphones",
    brand: "google",
    tags: ["Google", "Pixel", "5G", "128GB", "Tensor G3"],
    price: 115000,
    oldPrice: 130000,
    stock: "In stock",
    images: ["https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?w=600&h=400&fit=crop"],
    breadcrumb: "Home / Smartphones / Google",
    specs: [
      { feat: "Display", spec: "6.7-inch LTPO OLED 120Hz" },
      { feat: "Processor", spec: "Google Tensor G3" },
      { feat: "RAM", spec: "12GB" },
      { feat: "Storage", spec: "128GB" },
      { feat: "Camera", spec: "50MP + 48MP + 48MP" },
      { feat: "Battery", spec: "5050mAh" }
    ],
    delivery: "1-2 days",
    description: "Pure Android with exceptional camera AI.",
    rating: 4.7,
    reviews: 189
  },
  {
    ...
    category: "Smartphones",
    brand: "xiaomi",
    tags: ["Xiaomi", "14 Ultra", "5G", "512GB", "Leica"],
    price: 125000,
    oldPrice: 145000,
    stock: "In stock",
    ...
    specs: [
      { feat: "Display", spec: "6.73-inch AMOLED 120Hz" },
      { feat: "Processor", spec: "Snapdragon 8 Gen 3" },
      { feat: "RAM", spec: "16GB" },
      { feat: "Storage", spec: "512GB" },
      { feat: "Camera", spec: "50MP + 50MP + 50MP + 50MP" },
      { feat: "Battery", spec: "5000mAh" }
    ],
    delivery: "1-2 days",
  ...
  },
  {
    ...
    category: "Smartphones",
    brand: "oneplus",
    tags: ["OnePlus", "12", "5G", "256GB", "Snapdragon 8 Gen 3"],
    price: 95000,
    oldPrice: 110000,
    stock: "In stock",
    images: ["https://images.unsplash.com/photo-1585060544812-6b45742d762f?w=600&h=400&fit=crop"],
    breadcrumb: "Home / Smartphones / OnePlus",
    specs: [
      { feat: "Display", spec: "6.82-inch LTPO AMOLED 120Hz" },
      { feat: "Processor", spec: "Snapdragon 8 Gen 3" },
      { feat: "RAM", spec: "12GB" },
      { feat: "Storage", spec: "256GB" },
      { feat: "Camera", spec: "50MP + 48MP + 64MP" },
      { feat: "Battery", spec: "5400mAh" }
    ],
    delivery: "1-2 days",
    description: "Fast and smooth performance with Warp Charge.",
    rating: 4.6,
    reviews: 144
  },
  {
    id: 406,
    name: "OPPO Find X7 Ultra – 512GB, Blue",
    category: "Smartphones",
    brand: "oppo",
    tags: ["OPPO", "Find X7", "5G", "512GB", "Hasselblad"],
    price: 135000,
    oldPrice: 155000,
    stock: "In stock",
    images: ["https://images.unsplash.com/photo-1585060544812-6b45742d762f?w=600&h=400&fit=crop"],
    breadcrumb: "Home / Smartphones / OPPO",
    specs: [
      { feat: "Display", spec: "6.82-inch LTPO AMOLED 120Hz" },
      { feat: "Processor", spec: "Snapdragon 8 Gen 3" },
      { feat: "RAM", spec: "16GB" },
    ...
    delivery: "1-2 days",
    description: "Hasselblad quad-camera system.",
    rating: 4.5,
    reviews: 78
  },
  {
    id: 407,
    name: "Vivo X100 Pro – 256GB, Black",
    category: "Smartphones",
    brand: "vivo",
    tags: ["Vivo", "X100 Pro", "5G", "256GB", "Zeiss"],
    price: 105000,
    oldPrice: 120000,
    stock: "In stock",
    images: ["https://images.unsplash.com/photo-1585060544812-6b45742d762f?w=600&h=400&fit=crop"],
    breadcrumb: "Home / Smartphones / Vivo",
    specs: [
      { feat: "Display", spec: "6.78-inch AMOLED 120Hz" },
      { feat: "Processor", spec: "MediaTek Dimensity 9300" },
      { feat: "RAM", spec: "12GB" },
      { feat: "Storage", spec: "256GB" },
      { feat: "Camera", spec: "50MP + 50MP + 50MP" },
      { feat: "Battery", spec: "5400mAh" }
    ],
    delivery: "1-2 days",
    description: "Zeiss optics for professional-grade photos.",
    rating: 4.4,
    reviews: 67
  },
  {
    ...
    category: "Smartphones",
    brand: "huawei",
    tags: ["Huawei", "P60 Pro", "4G", "256GB", "XMAGE"],
    price: 115000,
    oldPrice: 135000,
    stock: "In stock",
    images: ["https://images.unsplash.com/photo-1585060544812-6b45742d762f?w=600&h=400&fit=crop"],
    breadcrumb: "Home / Smartphones / Huawei",
    specs: [
      { feat: "Display", spec: "6.67-inch LTPO OLED 120Hz" },
      { feat: "Processor", spec: "Snapdragon 8+ Gen 1 4G" },
      { feat: "RAM", spec: "8GB" },
      { feat: "Storage", spec: "256GB" },
      { feat: "Camera", spec: "48MP + 13MP + 48MP" },
      { feat: "Battery", spec: "4815mAh" }
    ],
    delivery: "1-2 days",
    description: "Premium camera phone with XMAGE imaging.",
    rating: 4.3,
    reviews: 93
  }
];
...
document.querySelectorAll('.categories-grid a, .dropdown-menu a, .mobile-dropdown-menu a').forEach(link => {
  link.addEventListener('click', (e) => {
    ...
    if (brand) {
      const filtered = smartphones.filter(p => p.brand === brand);
      renderSmartphones(filtered);
    } else if (category) {
      const filtered = smartphones.filter(p => p.category.toLowerCase() === category.toLowerCase() || p.brand === category);
      renderSmartphones(filtered);
    }
    categoriesDropdown.classList.remove('show');
  });
...
// "Smartphones" main link resets
document.querySelectorAll('.dropdown-toggle[href="smartphones.html"], .mobile-dropdown-toggle[href="smartphones.html"]').forEach(link => {
  link.addEventListener('click', (e) => {
    e.preventDefault();
    renderSmartphones(smartphones);
  });
...
function openModal(productId) {
  ...
  const related = smartphones.filter(p => p.id != productId && p.category === product.category).slice(0, 6);
